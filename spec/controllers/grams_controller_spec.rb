...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "should return a 404 error if we connot find a gram with the id that is specified" do
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#update action" do
    ...
    it "should allow users to sucessfully update grams" do 
    ...
    it "should have http 404 error if the gram cannot be found" do
      user = FactoryBot.create(:user)
      sign_in user
      get :update, params: { id: "MERCY", gram: { message: 'Changed' } }
      expect(response).to have_http_status(:not_found)
    end
  ...
  describe "grams#new action" do
    ...
    it "should require user is logged in" do
      get :new
      expect(response).to redirect_to new_user_session_path
    end
  ...
  describe "grams#create action" do
    ...
    it "should create a gram in our database" do
      user = FactoryBot.create(:user)
      sign_in user
